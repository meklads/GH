...
const COPY = {
  ar: {
    ...
    description:
      'وسّع قدرات وكالتك دون بناء فريق جديد — جرافيكس هاوس شريك إنتاج بصري وتجريبي متخصص لوكالات الإعلان والإبداع.',
    ...
    heroLead:
      'جرافيكس هاوس شريكك المتخصص في الإنتاج البصري والتجارب، نضيف إلى قدرات وكالتك ما تحتاجه مشاريع عملائك من الإظهار ثلاثي الأبعاد، الأفلام السينمائية، المجسمات المعمارية، التجارب التفاعلية وبيئات العرض.',
    ...
    ideaBody:
      'جرافيكس هاوس لا تأتي لتنافس وكالتك على العميل أو الاستراتيجية أو الحملة. نعمل كامتداد متخصص لفريقك، ونوفر القدرات الإنتاجية التي قد لا تحتاج وكالتك إلى بنائها داخليًا.',
    ...
    ideaHighlight: 'قدرات أكثر. فرص أكثر. دون قسم جديد.',
    fitTitle: 'فريقان. منظومة واحدة.',
    fitYouLabel: 'وكالتكم',
    fitYouLead: 'أنتم تقودون',
    ...
    benefits: [
      ...
      { n: '02', title: 'ارفع قيمة مشاريعك', desc: 'أدخل الإظهار ثلاثي الأبعاد والمجسمات والأفلام والتجارب التفاعلية ضمن عروضك ومشاريعك ذات القيمة العالية.' },
      { n: '03', title: 'استجب للموجزات المعقدة', desc: 'عندما يتحول المشروع من حملة إعلانية إلى تجربة متكاملة، لديك شريك متخصص يمكنه الدخول بسرعة.' },
      { n: '04', title: 'قلّل التعقيد', desc: 'بدل التنسيق بين عدة موردين متخصصين، تحصل على شريك واحد يدير طبقة الإنتاج.' },
      { n: '05', title: 'عزّز فرص الفوز', desc: 'يمكننا دعم العروض التقديمية التي تحتاج إلى تصور بصري أو منهج إنتاجي أكثر قوة.' },
      { n: '06', title: 'حافظ على مرونتك', desc: 'تعاون مع جرافيكس هاوس حسب الحاجة، دون إضافة تكاليف فريق دائم أو بنية إنتاج جديدة.' },
    ],
    capTitle: 'قدرات متخصصة.',
    capSub: 'متصلة حول مشروع واحد.',
    capFootH: 'شريك واحد متخصص.',
    capFootP: 'قدرات إنتاج متعددة.',
    capLearnMore: 'اعرف المزيد',
    capabilities: [
      { tag: 'تصوّر', title: 'الإظهار المعماري ثلاثي الأبعاد', desc: 'تحويل المخططات والأفكار إلى صور وتجارب بصرية واضحة ومقنعة.', href: 'services/rendering.html', img: 'assets/projects/rendering/Aloula-co-alnakheel-view02-scaled.jpg', webp: 'assets/projects/rendering/Aloula-co-alnakheel-view02-scaled.webp' },
      { tag: 'سرد', title: 'الأفلام السينمائية والرسوم المتحركة', desc: 'الأفلام السينمائية والرسوم المتحركة لسرد فكرة المشروع.', href: 'services/animation.html', img: 'assets/projects/cinematic/video-1.jpg', webp: 'assets/projects/cinematic/video-1.webp' },
      { tag: 'بناء', title: 'المجسمات المعمارية', desc: 'مجسمات معمارية دقيقة، نماذج تقديمية ومجسمات مميزة للمشاريع.', href: 'services/maquettes.html', img: 'assets/projects/maquettes/anan-eskan-maquette-01.jpeg', webp: 'assets/projects/maquettes/anan-eskan-maquette-01.webp' },
      { tag: 'تفاعل', title: 'التجارب التفاعلية', desc: 'شاشات تفاعلية، تجارب اللمس، الواقع الافتراضي والعروض الرقمية.', href: 'services/interactive.html', img: 'assets/projects/interactive-01.jpg', webp: 'assets/projects/interactive-01.webp' },
      { tag: 'تجربة', title: 'البيئات المادية والتجريبية', desc: 'بيئات العرض، المعارض، صالات المبيعات، التجارب المكانية والعناصر البصرية للمشاريع.', href: 'services/interactive.html', img: 'assets/projects/pavilion1.jpg', webp: 'assets/projects/pavilion1.webp' },
    ],
    plEyebrow: 'مثال على ما يمكننا أن نبنيه معًا',
    plTitle: 'Project Launch™',
    plSub: 'أحيِ مشروعك قبل أن يُبنى.',
    plBody: 'Project Launch™ هو نظام جرافيكس هاوس المتكامل لمساعدة المطورين وأصحاب المشاريع على رؤية مشاريعهم وفهمها وتجربتها قبل بنائها.',
    plItems: ['الإظهار ثلاثي الأبعاد', 'الأفلام السينمائية', 'المجسمات المعمارية', 'التجارب التفاعلية', 'الشاشات الرقمية', 'بيئات العرض'],
    plQuote: 'يمكن لوكالتك قيادة الاستراتيجية والتسويق والعلاقة مع العميل، بينما تتولى جرافيكس هاوس الطبقة البصرية والتجريبية المتخصصة.',
    ...
    pitchBody: 'بعض المشاريع تُحسم قبل توقيع العقد. عندما تحتاج وكالتك في عرض تقديمي أو مقترح إلى تصور أقوى لتجربة بصرية أو مجسم أو فيلم أو بيئة تفاعلية، يمكن لجرافيكس هاوس الدخول مبكرًا لدعم الجانب الإنتاجي من العرض.',
    pitchList: ['مفاهيم إبداعية', 'توجهات بصرية ثلاثية الأبعاد', 'مفاهيم مجسمات', 'مفاهيم تجربة', 'مناهج إنتاج', 'أصول العرض البصري'],
    pitchHighlight: 'ادخلونا في عرضكم التقديمي المعقد القادم.',
    pitchCta: 'ناقش عرضًا تقديميًا',
    modelsTitle: 'طريقة التعاون',
    models: [
      { n: '01', tag: 'إحالة', title: 'لديكم فرصة مناسبة لقدراتنا.', desc: 'تعرّفوننا بالمشروع، ونحدد معكم أفضل طريقة للتعاون.' },
      { n: '02', tag: 'تسليم مشترك', title: 'أنتم تقودون العميل. ونحن نقود تخصصنا.', desc: 'نعمل كجزء من فريق المشروع بأدوار واضحة ومسؤوليات محددة.' },
      { n: '03', tag: 'علامة بيضاء', title: 'حل إنتاج خلف الكواليس عند الحاجة.', desc: 'يمكن تنظيم بعض المشاريع بصيغة العلامة البيضاء وفق طبيعة المشروع واتفاق الطرفين، مع الالتزام بالسرية وحماية علاقة العميل.' },
      { n: '04', tag: 'شريك مفضّل', title: 'شراكة مستمرة وليست مشروعًا واحدًا.', desc: 'للوكالات التي لديها احتياج متكرر، يمكن بناء إطار تعاون طويل الأجل يشمل آلية العمل، الأولوية، الأسعار، والاستجابة للمشاريع.' },
    ],
    processTitle: 'من الموجز إلى التسليم',
    process: [
      { n: '01', title: 'تشاركونا الموجز', desc: 'تشاركونا احتياج العميل والسياق والمخرجات المطلوبة.' },
      { n: '02', title: 'نحدد الفرصة', desc: 'نحدد أين يمكن لجرافيكس هاوس إضافة أكبر قيمة.' },
      { n: '03', title: 'نبني نطاق الإنتاج', desc: 'نحدد المنهج، المخرجات، الجدول الزمني والتكلفة.' },
      { n: '04', title: 'نُنتج', desc: 'يتولى فريق جرافيكس هاوس تنفيذ وإدارة نطاق العمل المتفق عليه.' },
      { n: '05', title: 'تُسلّمون الحل الأكبر', desc: 'تعود المخرجات إلى منظومة مشروعكم لتصبح جزءًا من الحل النهائي للعميل.' },
    ],
    ...
    caseBody: 'ضمن مشروع معرض رابطة العالم الإسلامي، قامت جرافيكس هاوس بتطوير وتنفيذ عناصر بصرية وتجريبية جمعت بين المجسمات المعمارية، التجارب التفاعلية وبيئات العرض، لتحويل محتوى ومشاريع المؤسسة إلى تجربة يمكن رؤيتها وفهمها والتفاعل معها.',
    caseVideoCta: 'شاهد فيلم المشروع',
    caseHref: 'casestudy1.html',
    whyTitle: 'لماذا جرافيكس هاوس؟',
    whyItems: [
      { title: 'أكثر من 20 عامًا من الخبرة', sub: 'منذ 2004' },
      { title: 'مقرّنا في السعودية', sub: 'خبرة عميقة في السوق السعودي والمنطقة.' },
      { title: 'تخصصات متعددة', sub: 'عدة تخصصات إنتاجية تحت شريك واحد.' },
      { title: 'قابلية للتوسع', sub: 'فريق إنتاج متخصص وشبكة قدرات قابلة للتوسع حسب حجم المشروع.' },
      { title: 'خبرة مشاريع متنوعة', sub: 'مشاريع عقارية ومؤسسية وثقافية ومعارض وتجارب.' },
    ...
    principles: [
      ...
      { title: 'السرية', desc: 'اتفاقيات عدم الإفصاح والسرية متاحة للمشاريع التي تتطلب ذلك.' },
      { title: 'مسؤوليات واضحة', desc: 'نحدد المسؤوليات والمخرجات قبل بدء التنفيذ.' },
      { title: 'لا تواصل مباشر دون موافقة', desc: 'لا يتم التواصل المباشر مع عميل الشريك خارج إطار الاتفاق بين الطرفين.' },
      { title: 'تسليم احترافي', desc: 'جرافيكس هاوس مسؤولة عن جودة وتنفيذ نطاقها المتفق عليه.' },
    ],
    whoTitle: 'هل هذا مناسب لوكالتك؟',
    whoItems: [
      { title: 'وكالات الدعاية والإعلان', desc: 'وكالات الدعاية والإعلان والحملات المتكاملة.' },
      { title: 'الوكالات الإبداعية والعلامات', desc: 'الوكالات الإبداعية ووكالات بناء العلامات.' },
      { title: 'وكالات التسويق العقاري', desc: 'الوكالات المتخصصة في التسويق العقاري.' },
      { title: 'وكالات التجارب والفعاليات', desc: 'وكالات التجارب والفعاليات والتنشيط.' },
      { title: 'مكاتب الهندسة والتصميم', desc: 'المكاتب التي تحتاج إلى رفع مستوى تقديم المشاريع.' },
      { title: 'الاتصال الحكومي والمؤسسي', desc: 'الجهات التي تحتاج إلى تحويل المشاريع والمبادرات إلى تجارب بصرية.' },
    ],
    finalCtaTitle: 'لنبني معًا شيئًا أكبر.',
    finalCtaLead: 'لديكم مشروع أو عرض تقديمي أو عميل يحتاج إلى قدرات بصرية وتجريبية متقدمة؟',
    finalCtaSub: 'دعونا نرى كيف يمكن لجرافيكس هاوس أن تصبح امتدادًا متخصصًا لفريقكم.',
    finalCtaPrimary: 'ابدأ محادثة الشراكة',
    finalCtaSecondary: 'أرسل موجز مشروع',
    formTitle: 'طلب شراكة وكالة',
    formSub: 'شاركونا نبذة عن وكالتك وفرصة التعاون، وسيتواصل معك فريق جرافيكس هاوس لمناقشة الخطوة التالية.',
    ...
    pageFootTagline: 'نُجسّد المشاريع بصريًا. ونصنع تجارب لا تُنسى.',
