...
const css = `
  ...
  .pl-lp-header {
    ...
    background: rgba(250,250,248,.94); backdrop-filter: blur(14px); -webkit-backdrop-filter: blur(14px);
  ...
  .pl-lp-logo img { height: 42px; width: auto; display: block; }
  ...
  .pl-lp-icon {
    ...
    border-radius: var(--pl-radius); transition: border-color .2s, color .2s;
  }
  .pl-lp-icon:hover { border-color: var(--pl-gold); color: var(--pl-gold); }
  @media (max-width: 720px) {
    .pl-lp-logo img { height: 36px; }
