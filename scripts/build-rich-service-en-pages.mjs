...
const PAGES = [
  {
    ...
    heroGold: 'Workflows',
    heroSub: 'We integrate AI into visualization, content production, and sales enablement to shorten delivery cycles while keeping studio-grade quality for Saudi and GCC masterplans.',
