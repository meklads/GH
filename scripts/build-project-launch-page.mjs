...
<section class="relative h-screen flex items-center justify-center overflow-hidden">
  ...
  <div class="relative z-10 text-center max-w-5xl px-6">
    <span class="hero-enter font-label-caps text-label-caps text-primary tracking-[0.3em] mb-6 block" style="transition-delay:0ms">${t.eyebrow}</span>
    <h1 class="hero-enter text-[52px] md:text-[82px] leading-tight mb-6" style="transition-delay:120ms">${t.h1}</h1>
    <p class="hero-enter font-body-lg text-secondary max-w-2xl mx-auto mb-12 opacity-80" style="transition-delay:240ms">${t.heroLead}</p>
    <div class="hero-enter flex flex-wrap justify-center gap-4 md:gap-6" style="transition-delay:360ms">
      ...
      <a href="${t.portfolio}" class="border border-primary text-primary px-8 py-4 font-label-caps text-label-caps tracking-widest transition-all hover:bg-primary/10">${t.ctaSecondary}</a>
    </div>
  </div>
</section>
