...
const PRODUCTS = [
  {
    ...
    ar: {
      ...
      desc: 'مشكلة المطور: حملات تجلب زيارات لكن الفريق يتأخر في الرد. GrowthLaunch™ يربط العرض، التتبع، واتساب وCRM في مسار مبيعات قابل للقياس.',
      eyebrow: 'الحل المتكامل',
      h1Ar: 'نظام توليد العملاء والمبيعات',
      heroHeadline: 'من أول نقرة إلى صفقة مغلقة: مسار مبيعات متصل، لا حملة منفصلة',
      heroLead: 'جذب مؤهل، رد خلال دقائق، ومتابعة آلية بعد جاهزية <a href="../solutions/project-launch.html">ProjectLaunch™</a> للعرض والصالة.',
      gapTitle: 'لماذا تضيع الفرص بعد الحملة؟',
      gapLead: 'الإعلان يجلب زيارات، لكن بدون رد سريع ومسار CRM واضح، يبرد العميل قبل أن يلمسه فريق المبيعات. راجع <a href="../insights/articles/riyadh-offplan-visual-sales.html">مبيعات off-plan في الرياض</a>.',
      ...
      outcomes: [
        ...
        ['تحسين مستمر', 'أرقام تشغيل حقيقية، لا vanity metrics'],
      ],
      overviewTag: 'المنظومة',
      overviewTitle: 'مسار مبيعات بعد جاهزية العرض',
      overviewLead: 'GrowthLaunch™ يربط الحملات بالرد والمتابعة والتحويل بعد أن يكون <a href="../solutions/brand-scale.html">BrandScale™</a> وProjectLaunch™ قد ثبتا الرسالة والصالة. أفلام الحملة يمكن توسيعها عبر <a href="https://beesmotion.com" target="_blank" rel="noopener noreferrer">بيزموشن</a> بعد قفل الأصول.',
      features: [
      ...
      ctaLead: 'جلسة واحدة لرسم العرض والقنوات ومسار التحويل، بلا التزام في الخطوة الأولى.',
    ...
    en: {
      ...
      desc: 'Developer problem: campaigns bring traffic but sales responds too late. GrowthLaunch™ connects offer, tracking, WhatsApp, and CRM in one measurable pipeline.',
      eyebrow: 'Flagship solution',
      h1Ar: '',
      heroHeadline: 'From first click to closed deal: one connected sales path, not a standalone campaign',
      heroLead: 'Qualified demand, response within minutes, and automated follow-up once <a href="../solutions/project-launch-en.html">ProjectLaunch™</a> has the offer and gallery ready.',
      gapTitle: 'Why do leads go cold after the campaign?',
      gapLead: 'Ads bring traffic, but without fast response and a clear CRM path, intent fades before sales touches the lead. See <a href="../insights/articles/riyadh-offplan-visual-sales-en.html">Riyadh off-plan visual sales</a>.',
      gapItems: ['Slow response after the ad', 'Data scattered across WhatsApp and spreadsheets', 'No view of each deal source'],
      ...
      outcomes: [
        ...
        ['Continuous optimization', 'Real operating numbers, not vanity metrics'],
      ],
      overviewTag: 'The system',
      overviewTitle: 'A sales path after the offer is ready',
      overviewLead: 'GrowthLaunch™ connects campaigns, response, and CRM once <a href="../solutions/brand-scale-en.html">BrandScale™</a> and ProjectLaunch™ have locked message and gallery. Campaign films can extend via <a href="https://beesmotion.com" target="_blank" rel="noopener noreferrer">Bees Motion</a> after assets lock.',
      features: [
  ...
  },
  {
    ...
    ar: {
      ...
      process: ['<a href="../services/branding.html">الهوية والتموضع واللغة البصرية</a>', 'CGI والأفلام والمجسمات والأدوات التفاعلية', 'ديكور صالة البيع والإخراج الفراغي', 'التصوير والإخراج والتركيب والتسليم'],
      processEyebrow: 'كيف نعمل',
      processTitle: 'المنهجية',
    ...
    en: {
      ...
      process: ['<a href="../services/branding-en.html">Identity, positioning and visual language</a>', 'CGI, films, maquettes and interactive tools', 'Sales-hall décor and spatial staging', 'Photography, direction, install and handover'],
      processEyebrow: 'How we work',
      processTitle: 'Methodology',
  ...
  },
  {
    ...
    ar: {
      ...
      desc: 'مشكلة المطور متعدد المشاريع: كل إطلاق يأتي بلغة مختلفة. BrandScale™ يبني تموضعاً وهوية قابلة للتوسع قبل ProjectLaunch™ وGrowthLaunch™.',
      eyebrow: 'نظام العلامة',
      h1Ar: 'نظام نمو العلامات التجارية',
      heroHeadline: 'من التموضع إلى حضور يفرض الثقة: نظام علامة، لا شعار منفصل',
      heroLead: 'تموضع، <a href="../services/branding.html">هوية بصرية</a>، أدلة للفريق، وحضور رقمي في لغة واحدة، حتى يراك السوق كمؤسسة واحدة مهما تعدّدت مشاريعك.',
      gapTitle: 'لماذا تضعف العلامة مع توسّع المشاريع؟',
      gapLead: 'كل مشروع جديد يُضاف بلغة مختلفة، فيختلط التموضع، يتشتت الفريق، وتضعف ثقة السوق قبل أن تبدأ المبيعات. راجع <a href="../insights/articles/masterplan-community-visual-sales.html">إطلاق المخططات الرئيسية</a>.',
      gapItems: [
      ...
      pillars: [
        ...
        { icon: 'layers', title: 'نظام قابل للتوسع', desc: '<a href="../services/branding.html">هوية</a> تعمل على المشروع الخامس كما على الأول، بلا إعادة اختراع أو تضارب بين الفرق والوكالات.' },
      ...
      outcomes: [
        ...
        ['<a href="../services/branding.html">نظام هوية</a>', 'شعار وألوان وطباعة قابلة للتوسع'],
        ['أدلة استخدام', 'فريقك يطبّق بنفس اللغة، بلا تفسيرات'],
        ['حضور رقمي', 'موقع ومواد تتوافق مع <a href="../solutions/project-launch.html">ProjectLaunch™</a> ومسارات النمو'],
        ['مواد جاهزة', 'قوالب للحملات والعروض والمطبوعات'],
        ['اتساق تراكمي', 'ثقة تتراكم مع كل مشروع، لا تُعاد من الصفر'],
      ],
      overviewTag: 'المنظومة',
      overviewTitle: '<a href="../services/branding.html">هوية</a> تصمد وتتوسع',
      overviewLead: 'BrandScale™ يبني نظام علامة واضح من التموضع إلى التطبيقات، حتى تتراكم الثقة مع كل مشروع وحملة. محتوى الحركة يمكن إنتاجه عبر <a href="../services/production.html">Dot4Life production</a> بعد قفل الدليل.',
      features: [
        'تموضع وهندسة رسائل للمطورين والمؤسسات',
        'نظام شعار و<a href="../services/branding.html">هوية بصرية</a> قابل للتوسع',
      ...
      process: [
        ...
        ['<a href="../services/branding.html">بناء نظام الهوية</a>', 'شعار، ألوان، طباعة، وقواعد الاستخدام'],
      ...
      deliverables: [
        ...
        { icon: 'palette', title: '<a href="../services/branding.html">نظام الهوية البصرية</a>', desc: 'شعار، ألوان، خطوط، وقواعد الاستخدام' },
      ...
      faq: [
        ...
        ['هل يتكامل مع ProjectLaunch وGrowthLaunch؟', 'نعم، <a href="../services/branding.html">الهوية</a> تُسلَّم بلغة متوافقة مع الإطلاق ومسارات النمو، حتى لا تتعارض القنوات.'],
      ...
      ctaLead: 'جلسة واحدة لرسم التموضع ونطاق الهوية، بلا التزام في الخطوة الأولى.',
    ...
    en: {
      ...
      desc: 'Multi-project developer problem: every launch arrives with a different visual language. BrandScale™ builds positioning and a scalable identity before ProjectLaunch™ and GrowthLaunch™.',
      eyebrow: 'Brand system',
      h1Ar: '',
      heroHeadline: 'From positioning to a presence that commands trust: a brand system, not a standalone logo',
      heroLead: 'Positioning, <a href="../services/branding-en.html">visual identity</a>, team guidelines, and digital presence in one language, so the market sees one institution however many projects you launch.',
      gapTitle: 'Why does the brand weaken as projects multiply?',
      gapLead: 'Each new project arrives with a different visual language, positioning blurs, teams drift, and market trust erodes before sales begin. See <a href="../insights/articles/masterplan-community-visual-sales-en.html">masterplan community visual sales</a>.',
      gapItems: [
      ...
      pillars: [
        ...
        { icon: 'layers', title: 'A scalable system', desc: 'Identity that works on project five as well as project one, with no reinvention or conflict between teams and agencies.' },
      ...
      outcomes: [
        ...
        ['<a href="../services/branding-en.html">Identity system</a>', 'Logo, colour and print that scale'],
        ['Usage guidelines', 'Your team applies the same language, no guesswork'],
        ['Digital presence', 'Web and collateral aligned with <a href="../solutions/project-launch-en.html">ProjectLaunch™</a> and growth paths'],
      ...
      overviewLead: 'BrandScale™ builds a clear brand system from positioning to applications, so trust compounds with every project and campaign. Motion content can run through <a href="../services/production-en.html">Dot4Life production</a> after the guide locks.',
      features: [
        'Positioning and messaging for developers and institutions',
        '<a href="../services/branding-en.html">Scalable logo and visual identity system</a>',
      ...
      process: [
        ...
        ['<a href="../services/branding-en.html">Identity system design</a>', 'Logo, colour, typography and usage rules'],
      ...
      deliverables: [
        ...
        { icon: 'palette', title: '<a href="../services/branding-en.html">Visual identity system</a>', desc: 'Logo, colour, typography and usage rules' },
      ...
      faq: [
        ...
        ['Does it connect with ProjectLaunch and GrowthLaunch?', 'Yes, <a href="../services/branding-en.html">identity</a> is delivered in a language compatible with launch and growth paths.'],
...
function buildPremiumPage(product, isEn) {
  ...
  <div class="gl-roi-inner reveal" style="opacity:0;transform:translateY(20px)">
    ...
    <p class="gl-roi-lead">${isEn ? 'Adjust your numbers and see estimated revenue with slow vs. fast lead response (illustrative).' : 'عدّل أرقامك وتقدير للإيراد مع رد بطيء مقابل رد سريع (تقريبي).'}</p>
...
<link rel="stylesheet" href="../assets/gh-site-enhancements.css?v=34">
<link rel="stylesheet" href="../assets/site-header.css?v=49">
