...
function ensureHeaderCssOrder(html, prefix) {
  const headerHref = `${prefix}site-header.css?v=36`;
...
function syncFile(rel) {
  ...
  html = html.replace(/gh-site-enhancements\.css\?v=\d+/g, 'gh-site-enhancements.css?v=28');
  ...
  const enhHref = `${prefix}gh-site-enhancements.css?v=28`;
