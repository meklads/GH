...
const EXPECT_CSS = 'site-header.css?v=22';
...
for (const rel of collectHtml(ROOT)) {
  ...
  if (html.includes('<footer dir=')) {
    ...
    if (!/gh-site-enhancements\.css\?v=18/.test(html)) {
      issues.push(`${rel}: missing versioned footer CSS (gh-site-enhancements.css?v=18)`);
    }
  }
}
